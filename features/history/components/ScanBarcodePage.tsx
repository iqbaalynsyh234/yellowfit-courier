...
export default function ScanBarcodePage({ value, onChange, onScanClick }: ScanBarcodePageProps) {
  return (
    <div className="w-full max-w-[375px] bg-[#FFD823] px-4 pt-6 pb-4 relative z-10">
      ...
      <div className="text-black text-sm mb-3">Masukkan Kode Barcode atau scan barcode</div>
      <div className="flex items-center bg-white rounded-xl px-3 py-2 shadow">
        <input
          ...
          onChange={onChange}
        />
        <button onClick={onScanClick} type="button">
          <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
            <circle cx="11" cy="11" r="8" stroke="#FFD823" strokeWidth="2" />
            <path d="M21 21l-4.35-4.35" stroke="#FFD823" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </button>
      </div>
    </div>
