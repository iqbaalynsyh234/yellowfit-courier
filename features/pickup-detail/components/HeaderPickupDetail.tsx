  ...
  return (
    <div className="bg-[#FFD823] w-full max-w-[470px] mx-auto px-4 pt-4 pb-4 flex flex-col gap-2 rounded-none">
      <div className="flex items-center gap-2 mb-2">
        ...
        >
          <svg width="27" height="27" fill="none" viewBox="0 0 24 24">
            <path d="M15 19l-7-7 7-7" stroke="#232323" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="bg-white rounded-full p-2 h-12 w-12 flex items-center justify-center border border-gray-300" onClick={onScanClick}>
